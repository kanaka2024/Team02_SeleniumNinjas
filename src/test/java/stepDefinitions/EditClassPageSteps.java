...
public class EditClassPageSteps {
	...
	public void a_new_edit_pop_up_with_class_details_appears() throws InterruptedException {
		...
		if (isClassFound) {
			...
			System.out.println("Edit Class title " + cdText);
	...
	public void admin_enters_all_mandatory_field_values_with_valid_data_in_edit_class_and_clicks_save_button_and(String testCase, String sheetName) throws InterruptedException {
